"""
Base class for camara-audit plugins. Every plugin's scan() must call
...
from camara_audit.core.engagement import Engagement
from camara_audit.core.models import Finding, ModuleResult
